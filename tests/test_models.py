...
class TestProductModel(unittest.TestCase):
    ...
    def test_read_a_product(self):
        ...
        self.assertEqual(found_product.id, product.id) # assertion of product id
        self.assertEqual(found_product.name, product.name) # assertion of product name
        self.assertEqual(found_product.price, product.price) # assertion of product price
   ...
   def test_update_a_product(self):
    ...
    def test_delete_a_product(self):
        product = ProductFactory() # product object
        product.create() # creating a product
        self.assertEqual(len(Product.all()), 1) #checking to see if product is occupied
